            ...
            <div class="col-lg-12">
                <div class="card-style mb-30">
                    <div class="title d-flex flex-wrap align-items-center justify-content-between ">
                        <div class="left">
                            <h6 class="text-medium mb-30">Edit Kajian Antara</h6>
                        </div>
                        <div class="right">
                            <a href="<?= base_url('kajian/antara'); ?>" class="btn btn-outline-primary d-flex align-items-center">
                    ...
                    <!-- End Title -->
                    <form action="<?= route_to('antara-update'); ?>" method="POST" enctype="multipart/form-data">
