...
<body>
    ...
    <main class="page-center">
        <article class="sign-up">
            ...
            <p class="sign-up__subtitle">Silakan masuk dengan akun anda.</p>
            <form class="sign-up-form form" action="<?= base_url('login/auth'); ?>" method="POST">
                ...
                <a class="link-info forget-link" href="<?= route_to('forgot'); ?>">Lupa Password?</a>
                <button type="submit" name="submit" class="form-btn primary-default-btn transparent-btn">Sign in</button>
                <span class="mt-3">Belum memiliki akun? <a class="link-info forget-link" href="<?= route_to('register'); ?>">Daftar Sekarang.</a></span>
            </form>
        </article>
    </main>
    <!-- Chart library -->
